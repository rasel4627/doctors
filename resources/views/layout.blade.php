  ...
  <div class="container-scroller">
    <nav class="navbar navbar-light col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper">
        <a class="navbar-brand brand-logo" href="{{ url('admin-dashboard')}}"><img src="{{ asset('public/images/admin-logo-png-2-Transparent-Images.png')}}" alt="Logo"></a>
      </div>
    ...
    <div class="container-fluid page-body-wrapper">
      <div class="row row-offcanvas row-offcanvas-right">
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
          <div class="user-info">
            <div class="profile">
              <img src="{{ asset('public/images/developer.png') }}" alt="image">
            </div>
            <div class="details">
          ...
          <ul class="nav">
            ...
            <li class="nav-item">
              <a class="nav-link" href="{{ url('/all-doctor')}}">
                ...
                <span class="menu-title">Doctor's</span>
              </a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
              <a class="nav-link" href="{{ url('/all-appointments')}}">
                <i class="mdi mdi-gauge menu-icon"></i>
        ...
        @endphp
          ...
          <li class="nav-item">
              <a class="nav-link" data-toggle="collapse" href="#sidebar_layouts" aria-expanded="false" aria-controls="sidebar_layouts">
                ...
                <span class="menu-title">Treatment Types</span>
              ...
              <div class="collapse" id="sidebar_layouts">
                ...
                @foreach($category as $row)
                  <li class="nav-item">
                    <a class="nav-link" href="">{{ $row->treatment_name }}</a>
                  </li>
                @endforeach
                </ul>
              </div>
            ...
            <li class="nav-item">
              <a class="nav-link" href="{{ url('/add-treatment-category') }}">
                <i class="mdi mdi-format-list-bulleted menu-icon"></i>
                <span class="menu-title">Add Treatment Category</span>
              </a>
            </li>
